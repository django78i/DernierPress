<div class="spbsm-follow-wrapper">
					...
					<h2><?php printf( __( '%s: Posts & Pages', 'spbsm' ), $currentButtons );?></h2>
					<p class="headline-description"><?php printf( __( 'Choose where you want the social media %s to display on posts and pages.', 'spbsm' ), strtolower($currentButtons));?></p>
					<table>
						<tr>
							<td>
								<?php echo __( "Start of Posts", 'spbsm' );?>
							</td>
							<td>
						...
						<tr>
							<td>
								<?php echo __( "End of Posts", 'spbsm' );?>
							</td>
							<td>
						...
						<tr>
							<td>
								<?php echo __( "Start of Pages", 'spbsm' );?>
							</td>
							<td>
						...
						<tr>
							<td>
								<?php echo __( "End of Pages", 'spbsm' );?>
							</td>
							<td>
					...
					<h2><?php printf( __( '%s: Floating Sidebar', 'spbsm' ), $currentButtons );?></h2>
					...
					<table>
						<tr>
							<td>
								<?php echo __( "Floating Sidebar", 'spbsm' );?>
							</td>
							<td>
								<select name="floatingSidebar">
									<option value="0" <?php echo ($positionSettings['floatingSidebar']==0?'selected':'')?>><?php echo __( "Off", 'spbsm' );?></option>
									<option value="1" <?php echo ($positionSettings['floatingSidebar']==1?'selected':'')?>><?php echo __( "Left Center", 'spbsm' );?></option>
									<option value="2" <?php echo ($positionSettings['floatingSidebar']==2?'selected':'')?>><?php echo __( "Right Center", 'spbsm' );?></option>
									<option value="3" <?php echo ($positionSettings['floatingSidebar']==3?'selected':'')?>><?php echo __( "Bottom Right", 'spbsm' );?></option>
									<option value="4" <?php echo ($positionSettings['floatingSidebar']==4?'selected':'')?>><?php echo __( "Bottom Left", 'spbsm' );?></option>
								</select>
							</td>
						</tr>
						<tr>
