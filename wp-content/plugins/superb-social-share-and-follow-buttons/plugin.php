<?php
    final class spbsm
    {
        ...
        {
            $this->queueErrorResponse =  __("Couldn't save settings. Order data invalid.", 'spbsm');
            $this->urlErrorResponse =  __("Couldn't save settings. Profile link should be https.", 'spbsm');
            $this->sidebarErrorResponse =  __("Couldn't save settings. Sidebar setting invalid.", 'spbsm');
            $this->designErrorResponse = __("Couldn't save settings. Selected button design is invalid.", 'spbsm');
            $this->colorErrorResponse = __("Couldn't save settings. A selected color is not a valid color.", 'spbsm');
            $this->genericErrorResponse = __("Couldn't save settings. Data invalid.", 'spbsm');
            $this->defaultFollowText = __("Follow us on Social Media", 'spbsm');
            $this->defaultShareText = __("Share on Social Media", 'spbsm');
        }
        ...
        public function backend_enqueue($hook)
        {
            if ($hook == $this->page_hook_s || $hook == $this->page_hook_f) {
                ...
                'alreadySaved'  => __("Current settings already saved..", 'spbsm'),
                'error' => __("Couldn't save settings..", 'spbsm'),
                'fieldErrorMultiple' => __("fields are not valid profile links..", 'spbsm'),
                'fieldErrorSingle' => __("field is not a valid profile link..", 'spbsm'),
                'fieldErrorExpected' => __(" Expected https://(site).com/(profile) or similar.", 'spbsm'),
            ));
            }
        }
